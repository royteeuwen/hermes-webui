...
if(typeof navigator!=='undefined'&&navigator.serviceWorker&&!window.__hermesPushNavWired){
  ...
  navigator.serviceWorker.addEventListener('message',(event)=>{
    ...
    if(sid&&typeof loadSession==='function'){
      ...
      // loadSession() hides the home/empty view and paints the loading state
      // synchronously (before its metadata fetch), so the in-place switch never
      // flashes the home screen. Hard-nav fallback if the router throws.
